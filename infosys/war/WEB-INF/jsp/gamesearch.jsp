...
<html>
<head>
	<title>GameN'Watch - Find Games</title>
...
<div id="rightcontent">
	<form method="post">
		<spring:bind path="game.name">
		Name: <input type="text" name="name" value="<c:out value="${status.value}"/>">&nbsp;&nbsp;<span class="error"><c:out value="${status.errorMessage}"/></span><br>
		</spring:bind>
